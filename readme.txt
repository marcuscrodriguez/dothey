...
- **Questionnaire Interface:** Users can interact with the web application to answer a series of questions related to their relationship.
- **Sentiment Analysis:** Text responses provided by users are analyzed for sentiment (positive, neutral, negative) to provide insights into relationship dynamics.
- **Results Interpretation:** Based on questionnaire responses and sentiment analysis, the application provides interpretations and an overall score taking into consideration different aspects of the relationship.
...
- Marcus C. Rodriguez (https://github.com/marcuscrodriguez/dothey): Developer
